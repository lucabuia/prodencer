...
# ABINIT
lattice, grid, charge, mx, my, mz = ABINIT_get_density("CrSb_DEN.nc")


# Corner Cr ion
center = np.array([0, 0, 0]) # Coordinates of the corner Cr ion
radius = 2.108

# Get all symmetry-equivalent positions
positions = np.round(wyckoff(center, 488),5)
...
output_analytical_densities(lattice, positions, radius, coeffs, "CrSb_2a_Mx")